...
class YatubeTest(TestCase):
    def setUp(self):
        ...
        self.test_text_2 = '3ci5tf2n8dhg2b62fbtwgcnh48g5dgwveveveverqdybwd'
        self.test_comment = 'gwwgmy5gv4u5fgygehnyh5gugghdygbeuy5uvgdtegu45'
        self.img = Image.new("RGBA", (200, 200), (255, 0, 0, 0))
    ...
    def test_404_status(self):
        ...
        response = self.client_authorized.get(
            reverse(
                'profile',
                args={'username': 'несуществующий пользователь'},
                ),
            )
    ...
    def test_follow_check(self):
        ...
        response = Follow.objects.get(user=self.user, author=self.user_2)
        self.assertEqual(self.user, response.user)
        self.assertEqual(self.user_2, response.author)
